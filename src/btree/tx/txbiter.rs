use crate::btree::{kv::{node::BNode, nodeinterface::BNodeReadInterface}, BTreeError};

use super::txinterface::TxReadContext;


pub struct TxBIter<'a>{
    context: &'a dyn TxReadContext,    
...
impl<'a> TxBIter<'a> {
    ...
    pub fn new(context:&'a dyn TxReadContext) -> Self {
        TxBIter {
            context: context,
            path: Vec::new(),
            pos: Vec::new(),
