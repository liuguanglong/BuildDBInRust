...
fn zero_or_more<'a,P1,R1>(p1:P1) -> impl Parser<'a, Vec<R1>>
where
  P1 : Parser<'a,R1>
{
    move |mut input|{
...
fn one_or_more<'a,P1,R1>(p1:P1) -> impl Parser<'a, Vec<R1>>
where
  P1 : Parser<'a,R1>
{
    move |mut input| {
...
fn pred<'a,P,A,F>(parser:P,pred:F)->impl Parser<'a,A>
where 
   P: Parser<'a,A>,
   F: Fn(&A)->bool,
{
...
fn number_string<'a>() -> impl Parser<'a,String>
{
    map(
